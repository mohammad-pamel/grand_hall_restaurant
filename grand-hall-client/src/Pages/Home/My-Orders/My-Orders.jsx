...
//                 <td>
//                   <span
//                     className={`text-white px-2 py-1 rounded ${statusColor(order.status)}`}
//                   >
//                     {order.status}
//                   </span>
//                 </td>
//                 <td>
//                   <span
//                     className={`text-white px-2 py-1 rounded ${paymentStatusColor(order.paymentStatus)}`}
//                   >
//                     {order.paymentStatus}
//                   </span>
//                 </td>
...
//                       </button>
//                     ) : (
//                       <span className='bg-red-600 p-1 text-sm'>
//                         Not Allowed
//                       </span>
//                     )
//                   }
