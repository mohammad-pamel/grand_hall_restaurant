...
async function startServer() {
  try {
    ...
    app.post('/paymentBkash', async (req, res) => {
      // console.log("PAYMENT BKASH ROUTE HIT");
      ...
      try {
        ...
        const data = {
          ...
          product_name: orderData.items[0].foodName,
        ...
        // console.log("SSL Object Created");
    ...
    app.post('/payment/success/:tran_id', async (req, res) => {
      ...
      if (result.modifiedCount > 0) {
        res.redirect(
          `https://grand-hall.web.app/payment/success/${tran_id}`
    ...
    app.post('/payment/fail/:tran_id', async (req, res) => {
      ...
      try {
        ...
        res.redirect(
          `https://grand-hall.web.app/payment/fail/${tran_id}`
          // `http://localhost:5173/payment/fail/${tran_id}`
        )
    ...
    app.post('/payment/cancel/:tran_id', async (req, res) => {
      ...
      try {
        ...
        res.redirect(
          `https://grand-hall.web.app/payment/cancel/${tran_id}`
          // `http://localhost:5173/payment/cancel/${tran_id}`
